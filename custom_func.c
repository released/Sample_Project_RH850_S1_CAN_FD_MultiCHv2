...
#define FLAG_PROJ_TRIG_7                                (flag_PROJ_CTL.bit14)
#define FLAG_PROJ_TRIG_8                                (flag_PROJ_CTL.bit15)
...
volatile unsigned long g_u32_counter2 = 0U;
...
void loop(void)
{
    ...
    if (FLAG_PROJ_TRIG_1)
    {
        ...
        can_bus_variable_ch0.can_tx1_flag = 1;
        #endif
        #if defined (ENABLE_CAN1)
        can_bus_variable_ch1.can_tx1_flag = 1;
        #endif
        FLAG_PROJ_TRIG_1 = 0;
    }
    ...
    {
        #if defined (ENABLE_CAN0)
        can_bus_variable_ch0.can_tx2_flag = 1;
        #endif
        #if defined (ENABLE_CAN1)
        can_bus_variable_ch1.can_tx2_flag = 1;
        #endif
        FLAG_PROJ_TRIG_2 = 0;
    }
    ...
    {
        #if defined (ENABLE_CAN0)
        can_bus_variable_ch0.can_tx3_flag = 1;
        #endif
        #if defined (ENABLE_CAN1)
        can_bus_variable_ch1.can_tx3_flag = 1;
        #endif
        FLAG_PROJ_TRIG_3 = 0;
    }
    ...
    {
        #if defined (ENABLE_CAN0)
        can_bus_variable_ch0.can_tx4_flag = 1;
        #endif
        #if defined (ENABLE_CAN1)
        can_bus_variable_ch1.can_tx4_flag = 1;
        #endif
        FLAG_PROJ_TRIG_4 = 0;
    }
    ...
    if (FLAG_PROJ_TRIG_5)
    {
        ...
        can_bus_variable_ch2.can_tx1_flag = 1;
        #endif
        #if defined (ENABLE_CAN4)
        can_bus_variable_ch4.can_tx1_flag = 1;
        #endif
        FLAG_PROJ_TRIG_5 = 0;
    }
    ...
    {
        #if defined (ENABLE_CAN2)
        can_bus_variable_ch2.can_tx2_flag = 1;
        #endif
        #if defined (ENABLE_CAN4)
        can_bus_variable_ch4.can_tx2_flag = 1;
        #endif
        FLAG_PROJ_TRIG_6 = 0;
    }
    ...
    {
        #if defined (ENABLE_CAN2)
        can_bus_variable_ch2.can_tx3_flag = 1;
        #endif
        #if defined (ENABLE_CAN4)
        can_bus_variable_ch4.can_tx3_flag = 1;
        #endif
        FLAG_PROJ_TRIG_7 = 0;
    }
    ...
    {
        #if defined (ENABLE_CAN2)
        can_bus_variable_ch2.can_tx4_flag = 1;
        #endif
        #if defined (ENABLE_CAN4)
        can_bus_variable_ch4.can_tx4_flag = 1;
        #endif
        FLAG_PROJ_TRIG_8 = 0;
    }
