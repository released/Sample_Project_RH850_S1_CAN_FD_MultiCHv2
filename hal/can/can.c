...
/*
    ...
    data : 5M
        ...
        enable TDCE , TDCOC , TDCO[[6:0]
*/


#if defined (ENABLE_CAN0)

CAN_BUS_HANDLE  can_bus_handle_ch0;

volatile CAN_BUS_GLOBAL_VARIABLE_T can_bus_variable_ch0 = 
{
    .can_tx1_flag           = 0U,
    .can_tx2_flag           = 0U,
    .can_tx3_flag           = 0U,
...
const CAN_BUS_PARAMETER_T can_bus_parameter_ch0 = 
{
    .CAN_CH                 = CAN_CHANNEL_0,
...
const CAN_RX_RULE_TABLE_T can_bus_rx_rule_tbl_ch0[CAN_RX_RULE_CURRENT_AMOUNT] = 
{
    /*
        {
            .GAFLID = RX_RRT5_ID,
            .GAFLLB = OTHER_NODE_TRANSMIT_MSG_RECEIVED,    //Receive Rule Target Message Select
            .GAFLRTR = (unsigned char)RX_DATA_FRAME,    //RTR Select
            .GAFLIDE = (unsigned char)RX_STANDARD_ID,   //IDE Select
            // .GAFLIDE = (unsigned char)RX_EXTEND_ID,   //IDE Select

            .GAFLIDM = STANDARD_ID_BIT_IS_COMPARED,   //1: The corresponding ID bit is compared.
            // .GAFLIDM = EXTEND_ID_BIT_IS_COMPARED,   //1: The corresponding ID bit is compared.
            .Reserved0 = RESERVED_BIT,
            .GAFLRTRM = RTR_BIT_IS_COMPARED,  //1: The RTR bit is compared.
            .GAFLIDEM = IDE_BIT_IS_COMPARED,  //1: The IDE bit is compared.

            .GAFLDLC = (unsigned char)CAN_DLC_DISABLE_CHECK,
            .Reserved1 = RESERVED_BIT,
            .GAFLRMDP = can_bus_parameter_ch1.CAN_RX_FIFO_BUFFER_NUM,
            .GAFLRMV = A_RECEIVE_BUFFER_IS_USED,   //1: A receive buffer is used.
            .GAFLPTR = 0x5555,  //Receive Rule Label

            .GAFLFDP_x = (0x1<<can_bus_parameter_ch1.CAN_RX_FIFO_BUFFER_NUM),
            .GAFLFDP_k = TRANSMIT_RECEIVE_FIFO_BUFFER_IS_NOT_SELECTED,  //Transmit/Receive FIFO Buffer k Select
        },    
        {
            RX_RRT5_ID,
            OTHER_NODE_TRANSMIT_MSG_RECEIVED,
            (unsigned char)RX_DATA_FRAME,
            (unsigned char)RX_STANDARD_ID,
            STANDARD_ID_BIT_IS_COMPARED,
            RESERVED_BIT,
            RTR_BIT_IS_COMPARED,
            IDE_BIT_IS_COMPARED,
            (unsigned char)CAN_DLC_DISABLE_CHECK,
            RESERVED_BIT,
            can_bus_parameter_ch1.CAN_RX_FIFO_BUFFER_NUM,
            A_RECEIVE_BUFFER_IS_USED,
            0x5555,
            (0x1<<can_bus_parameter_ch1.CAN_RX_FIFO_BUFFER_NUM),
            TRANSMIT_RECEIVE_FIFO_BUFFER_IS_NOT_SELECTED,
        },    
    */

        {
            .GAFLID = RX0_RRT0_ID,
            .GAFLLB = OTHER_NODE_TRANSMIT_MSG_RECEIVED,
            .GAFLRTR = RX_DATA_FRAME,
            .GAFLIDE = RX_EXTEND_ID,
            .GAFLIDM = EXTEND_ID_BIT_IS_COMPARED,
            .Reserved0 = RESERVED_BIT,
            .GAFLRTRM = RTR_BIT_IS_COMPARED,
            .GAFLIDEM = IDE_BIT_IS_COMPARED,
            .GAFLDLC = CAN_DLC_DISABLE_CHECK,
            .Reserved1 = RESERVED_BIT,
            .GAFLRMDP = CAN_RX_FIFO_BUFFER_NUMBER0,
            .GAFLRMV = A_RECEIVE_BUFFER_IS_USED,
            .GAFLPTR = (0x1234U),
            .GAFLFDP_x = (0x1U<<CAN_RX_FIFO_BUFFER_NUMBER0),
            .GAFLFDP_k = TRANSMIT_RECEIVE_FIFO_BUFFER_IS_NOT_SELECTED,
        },
        {
            .GAFLID = RX0_RRT1_ID,
            .GAFLLB = OTHER_NODE_TRANSMIT_MSG_RECEIVED,
            .GAFLRTR = RX_DATA_FRAME,
            .GAFLIDE = RX_STANDARD_ID,
            .GAFLIDM = STANDARD_ID_BIT_IS_COMPARED,
            .Reserved0 = RESERVED_BIT,
            .GAFLRTRM = RTR_BIT_IS_COMPARED,
            .GAFLIDEM = IDE_BIT_IS_COMPARED,
            .GAFLDLC = CAN_DLC_DISABLE_CHECK,
...
volatile CAN_BUS_GLOBAL_VARIABLE_T can_bus_variable_ch1 = 
{
    .can_tx1_flag           = 0U,
    .can_tx2_flag           = 0U,
    .can_tx3_flag           = 0U,
...
const CAN_BUS_PARAMETER_T can_bus_parameter_ch1 = 
{
    .CAN_CH                 = CAN_CHANNEL_1,
    .CAN_MODE               = CAN_FD_MIX_MODE,
    .CAN_RX_FIFO_BUFFER_NUM = CAN_RX_FIFO_BUFFER_NUMBER1,
...
// filter ID : RX1_RRT0_ID ~ RX1_RRT9_ID
const CAN_RX_RULE_TABLE_T can_bus_rx_rule_tbl_ch1[CAN_RX_RULE_CURRENT_AMOUNT] = 
{ 

        {
            ...
            .GAFLDLC = CAN_DLC_DISABLE_CHECK,
            .Reserved1 = RESERVED_BIT,
            .GAFLRMDP = CAN_RX_FIFO_BUFFER_NUMBER1,
            .GAFLRMV = A_RECEIVE_BUFFER_IS_USED,
            .GAFLPTR = (0x1234U),
            .GAFLFDP_x = (0x1U<<CAN_RX_FIFO_BUFFER_NUMBER1),
            .GAFLFDP_k = TRANSMIT_RECEIVE_FIFO_BUFFER_IS_NOT_SELECTED,
        },
        {
            .GAFLID = RX1_RRT1_ID,
...
CAN_BUS_HANDLE  can_bus_handle_ch2;

volatile CAN_BUS_GLOBAL_VARIABLE_T can_bus_variable_ch2 = 
{
    .can_tx1_flag           = 0U,
    .can_tx2_flag           = 0U,
    .can_tx3_flag           = 0U,
...
const CAN_BUS_PARAMETER_T can_bus_parameter_ch2 = 
{
    .CAN_CH                 = CAN_CHANNEL_2,
    .CAN_MODE               = CAN_FD_MIX_MODE,
    .CAN_RX_FIFO_BUFFER_NUM = CAN_RX_FIFO_BUFFER_NUMBER2,
...
// filter ID : RX2_RRT0_ID ~ RX2_RRT9_ID
const CAN_RX_RULE_TABLE_T can_bus_rx_rule_tbl_ch2[CAN_RX_RULE_CURRENT_AMOUNT] = 
{ 

        {
            ...
            .GAFLDLC = CAN_DLC_DISABLE_CHECK,
            .Reserved1 = RESERVED_BIT,
            .GAFLRMDP = CAN_RX_FIFO_BUFFER_NUMBER2,
            .GAFLRMV = A_RECEIVE_BUFFER_IS_USED,
            .GAFLPTR = (0x1234U),
            .GAFLFDP_x = (0x1U<<CAN_RX_FIFO_BUFFER_NUMBER2),
            .GAFLFDP_k = TRANSMIT_RECEIVE_FIFO_BUFFER_IS_NOT_SELECTED,
        },
        {
            .GAFLID = RX2_RRT1_ID,
...
#if defined (ENABLE_CAN3)

CAN_BUS_HANDLE  can_bus_handle_ch3;

volatile CAN_BUS_GLOBAL_VARIABLE_T can_bus_variable_ch3 = 
{
    .can_tx1_flag           = 0U,
    .can_tx2_flag           = 0U,
    .can_tx3_flag           = 0U,
...
const CAN_BUS_PARAMETER_T can_bus_parameter_ch3 = 
{
    .CAN_CH                 = CAN_CHANNEL_3,
    .CAN_MODE               = CAN_FD_MIX_MODE,
...
// filter ID : RX3_RRT0_ID ~ RX3_RRT9_ID
const CAN_RX_RULE_TABLE_T can_bus_rx_rule_tbl_ch3[CAN_RX_RULE_CURRENT_AMOUNT] = 
{ 

        {
            ...
            .GAFLDLC = CAN_DLC_DISABLE_CHECK,
            .Reserved1 = RESERVED_BIT,
            .GAFLRMDP = CAN_RX_FIFO_BUFFER_NUMBER3,
            .GAFLRMV = A_RECEIVE_BUFFER_IS_USED,
            .GAFLPTR = (0x1234U),
            .GAFLFDP_x = (0x1U<<CAN_RX_FIFO_BUFFER_NUMBER3),
            .GAFLFDP_k = TRANSMIT_RECEIVE_FIFO_BUFFER_IS_NOT_SELECTED,
        },
        {
            .GAFLID = RX3_RRT1_ID,
...
#if defined (ENABLE_CAN4)

CAN_BUS_HANDLE  can_bus_handle_ch4;

volatile CAN_BUS_GLOBAL_VARIABLE_T can_bus_variable_ch4 = 
{
    .can_tx1_flag           = 0U,
    .can_tx2_flag           = 0U,
    .can_tx3_flag           = 0U,
...
const CAN_BUS_PARAMETER_T can_bus_parameter_ch4 = 
{
    .CAN_CH                 = CAN_CHANNEL_4,
    .CAN_MODE               = CAN_FD_MIX_MODE,
    .CAN_RX_FIFO_BUFFER_NUM = CAN_RX_FIFO_BUFFER_NUMBER4,
...
const CAN_RX_RULE_TABLE_T can_bus_rx_rule_tbl_ch4[CAN_RX_RULE_CURRENT_AMOUNT] = 
{
        {
            .GAFLID = RX4_RRT0_ID,
            .GAFLLB = OTHER_NODE_TRANSMIT_MSG_RECEIVED,
            ...
            .GAFLDLC = CAN_DLC_DISABLE_CHECK,
            .Reserved1 = RESERVED_BIT,
            .GAFLRMDP = CAN_RX_FIFO_BUFFER_NUMBER4,
            .GAFLRMV = A_RECEIVE_BUFFER_IS_USED,
            .GAFLPTR = (0x2234U),
            .GAFLFDP_x = (0x1U<<CAN_RX_FIFO_BUFFER_NUMBER4),
            .GAFLFDP_k = TRANSMIT_RECEIVE_FIFO_BUFFER_IS_NOT_SELECTED,
        },
        {
            .GAFLID = RX4_RRT1_ID,
...
// volatile CAN_BUS_RX_FIFO_FLAG_T can_bus_receive_fifo_interrupt_flag = 
// {
//     .RxBuffer0           = 0U,
//     .RxBuffer1           = 0U,
//     .RxBuffer2           = 0U,
...
const char* tbl_can_fifo_buffer_num[] =
{
    ...
    "CAN_RX_FIFO_BUFFER_NUMBER1",
    "CAN_RX_FIFO_BUFFER_NUMBER2",
    "CAN_RX_FIFO_BUFFER_NUMBER3",
    "CAN_RX_FIFO_BUFFER_NUMBER4",
    "CAN_RX_FIFO_BUFFER_NUMBER5",
    "CAN_RX_FIFO_BUFFER_NUMBER6",
    "CAN_RX_FIFO_BUFFER_NUMBER7",
};
...
static const CAN_ChannelConfig *s_can_cfg = NULL;
static size_t s_can_cnt = 0;

static const CAN_ChannelConfig g_can_cfg[] = 
{
	#if defined (ENABLE_CAN0)
    {   // CH0
        .p              = &can_bus_handle_ch0,
        .parameter      = &can_bus_parameter_ch0,
        .rx_rule_tbl    = can_bus_rx_rule_tbl_ch0,

        .rx_rule_count  = CAN_RX_RULE_CURRENT_AMOUNT,
        .depth          = CAN_RX_FIFO_BUFFER_DEPTH16,
        .payload        = CAN_RX_FIFO_BUFFER_PAYLOAD_64bytes,
        .int_timing     = CAN_RX_FIFO_BUFFER_FIFO_INT_FULL,        
    },
	#endif
	#if defined (ENABLE_CAN1)
    {   // CH1
        .p              = &can_bus_handle_ch1,
        .parameter      = &can_bus_parameter_ch1,
        .rx_rule_tbl    = can_bus_rx_rule_tbl_ch1,
	...
	#if defined (ENABLE_CAN2)
    {   // CH2
        .p              = &can_bus_handle_ch2,
        .parameter      = &can_bus_parameter_ch2,
        .rx_rule_tbl    = can_bus_rx_rule_tbl_ch2,
	...
	#if defined (ENABLE_CAN3)
    {   // CH3
        .p              = &can_bus_handle_ch3,
        .parameter      = &can_bus_parameter_ch3,
        .rx_rule_tbl    = can_bus_rx_rule_tbl_ch3,
	...
	#if defined (ENABLE_CAN4)
    {   // CH4
        .p              = &can_bus_handle_ch4,
        .parameter      = &can_bus_parameter_ch4,
        .rx_rule_tbl    = can_bus_rx_rule_tbl_ch4,
...
const CAN_ChannelConfig* CAN_GetConfig(size_t *count)
{
    static const size_t n = sizeof(g_can_cfg)/sizeof(g_can_cfg[0]);
    if (count) 
		*count = n;
    return g_can_cfg;
}
...
void can_rx_fifo_buf_int_check(CAN_REG_TYP * can,CAN_BUS_HANDLE *p, CAN_RX_FIFO_BUFER_NUMBER_e rfi_number)
{
    ...
    if(CAN_REG_READ(rfsts[rfi_number].UINT32,CAN_REG_BIT8,CAN_REG_LENGTH_8)!=0)
    {
        ...
        p->rx_data_ack.bytes |= (0x1<<rfi_number);
        // can_bus_variable_ch1.can_rx_fifo_cnt++;
    }
}
#endif

// void can_rx_fifo_interrupt_flag_log(CAN_REG_TYP * can)
// {
//     union __tagDAT *rfsts = (union __tagDAT *)(&can->CFDRFSTS0.UINT32);
//     unsigned char rx_fifo_buffer = 0U;

//     /*********************/
//     rx_fifo_buffer = 0;
//     if (can_bus_receive_fifo_interrupt_flag.RxBuffer0 > 0)
//     {
//         if ( (CAN_REG_READ(rfsts[rx_fifo_buffer].UINT32,CAN_REG_BIT0,CAN_REG_LENGTH_1)) == 0x00U)
//         {
//             tiny_printf("[rx fifo int:%d]\r\n",rx_fifo_buffer);
//         }
//         else
//         {
//             can_bus_receive_fifo_interrupt_flag.RxBuffer0 = 0;
//         }
//     }
//     /*********************/
//     rx_fifo_buffer = 1;
//     if (can_bus_receive_fifo_interrupt_flag.RxBuffer1 > 0)
//     {
//         if ( (CAN_REG_READ(rfsts[rx_fifo_buffer].UINT32,CAN_REG_BIT0,CAN_REG_LENGTH_1)) == 0x00U)
//         {
//             tiny_printf("[rx fifo int:%d]\r\n",rx_fifo_buffer);
...
//         else
//         {
//             can_bus_receive_fifo_interrupt_flag.RxBuffer1 = 0;
//         }
//     }
//     /*********************/
//     rx_fifo_buffer = 2;
//     if (can_bus_receive_fifo_interrupt_flag.RxBuffer2 > 0)
//     {
//         if ( (CAN_REG_READ(rfsts[rx_fifo_buffer].UINT32,CAN_REG_BIT0,CAN_REG_LENGTH_1)) == 0x00U)
//         {
//             tiny_printf("[rx fifo int:%d]\r\n",rx_fifo_buffer);
...
//         else
//         {
//             can_bus_receive_fifo_interrupt_flag.RxBuffer2 = 0;
//         }
//     }
//     /*********************/
//     rx_fifo_buffer = 3;
//     if (can_bus_receive_fifo_interrupt_flag.RxBuffer3 > 0)
//     {
//         if ( (CAN_REG_READ(rfsts[rx_fifo_buffer].UINT32,CAN_REG_BIT0,CAN_REG_LENGTH_1)) == 0x00U)
//         {
//             tiny_printf("[rx fifo int:%d]\r\n",rx_fifo_buffer);
...
//         else
//         {
//             can_bus_receive_fifo_interrupt_flag.RxBuffer3 = 0;
//         }
//     }
//     /*********************/
//     rx_fifo_buffer = 4;
//     if (can_bus_receive_fifo_interrupt_flag.RxBuffer4 > 0)
//     {
//         if ( (CAN_REG_READ(rfsts[rx_fifo_buffer].UINT32,CAN_REG_BIT0,CAN_REG_LENGTH_1)) == 0x00U)
//         {
//             tiny_printf("[rx fifo int:%d]\r\n",rx_fifo_buffer);
...
//         else
//         {
//             can_bus_receive_fifo_interrupt_flag.RxBuffer4 = 0;
//         }
//     }
//     /*********************/
//     rx_fifo_buffer = 5;
//     if (can_bus_receive_fifo_interrupt_flag.RxBuffer5 > 0)
//     {
//         if ( (CAN_REG_READ(rfsts[rx_fifo_buffer].UINT32,CAN_REG_BIT0,CAN_REG_LENGTH_1)) == 0x00U)
//         {
//             tiny_printf("[rx fifo int:%d]\r\n",rx_fifo_buffer);
...
//         else
//         {
//             can_bus_receive_fifo_interrupt_flag.RxBuffer5 = 0;
//         }
//     }
//     /*********************/
//     rx_fifo_buffer = 6;
//     if (can_bus_receive_fifo_interrupt_flag.RxBuffer6 > 0)
//     {
//         if ( (CAN_REG_READ(rfsts[rx_fifo_buffer].UINT32,CAN_REG_BIT0,CAN_REG_LENGTH_1)) == 0x00U)
//         {
//             tiny_printf("[rx fifo int:%d]\r\n",rx_fifo_buffer);
...
//         else
//         {
//             can_bus_receive_fifo_interrupt_flag.RxBuffer6 = 0;
//         }
//     }
//     /*********************/
//     rx_fifo_buffer = 7;
//     if (can_bus_receive_fifo_interrupt_flag.RxBuffer7 > 0)
//     {
//         if ( (CAN_REG_READ(rfsts[rx_fifo_buffer].UINT32,CAN_REG_BIT0,CAN_REG_LENGTH_1)) == 0x00U)
//         {
//             tiny_printf("[rx fifo int:%d]\r\n",rx_fifo_buffer);
...
//         else
//         {
//             can_bus_receive_fifo_interrupt_flag.RxBuffer7 = 0;
//         }
//     }

// }

// void can_rx_fifo_interrupt_flag_check(CAN_REG_TYP * can)
// {
//     union __tagDAT *rfsts = (union __tagDAT *)(&can->CFDRFSTS0.UINT32);

//     if(CAN_REG_READ(rfsts[0].UINT32,CAN_REG_BIT3,CAN_REG_LENGTH_1))
//     {
//         can_bus_receive_fifo_interrupt_flag.RxBuffer0 = 1U;
//         CAN_REG_CLR(rfsts[0].UINT32,CAN_REG_BIT3,CAN_REG_LENGTH_1);   //RFIF
//     }

//     if(CAN_REG_READ(rfsts[1].UINT32,CAN_REG_BIT3,CAN_REG_LENGTH_1))
//     {
//         can_bus_receive_fifo_interrupt_flag.RxBuffer1 = 1U;
//         CAN_REG_CLR(rfsts[1].UINT32,CAN_REG_BIT3,CAN_REG_LENGTH_1);   //RFIF
//     }

//     if(CAN_REG_READ(rfsts[2].UINT32,CAN_REG_BIT3,CAN_REG_LENGTH_1))
//     {
//         can_bus_receive_fifo_interrupt_flag.RxBuffer2 = 1U;
//         CAN_REG_CLR(rfsts[2].UINT32,CAN_REG_BIT3,CAN_REG_LENGTH_1);   //RFIF
//     }

//     if(CAN_REG_READ(rfsts[3].UINT32,CAN_REG_BIT3,CAN_REG_LENGTH_1))
//     {
//         can_bus_receive_fifo_interrupt_flag.RxBuffer3 = 1U;
//         CAN_REG_CLR(rfsts[3].UINT32,CAN_REG_BIT3,CAN_REG_LENGTH_1);   //RFIF
//     }

//     if(CAN_REG_READ(rfsts[4].UINT32,CAN_REG_BIT3,CAN_REG_LENGTH_1))
//     {
//         can_bus_receive_fifo_interrupt_flag.RxBuffer4 = 1U;
//         CAN_REG_CLR(rfsts[4].UINT32,CAN_REG_BIT3,CAN_REG_LENGTH_1);   //RFIF
//     }

//     if(CAN_REG_READ(rfsts[5].UINT32,CAN_REG_BIT3,CAN_REG_LENGTH_1))
//     {
//         can_bus_receive_fifo_interrupt_flag.RxBuffer5 = 1U;
//         CAN_REG_CLR(rfsts[5].UINT32,CAN_REG_BIT3,CAN_REG_LENGTH_1);   //RFIF
//     }

//     if(CAN_REG_READ(rfsts[6].UINT32,CAN_REG_BIT3,CAN_REG_LENGTH_1))
//     {
//         can_bus_receive_fifo_interrupt_flag.RxBuffer6 = 1U;
//         CAN_REG_CLR(rfsts[6].UINT32,CAN_REG_BIT3,CAN_REG_LENGTH_1);   //RFIF
//     }

//     if(CAN_REG_READ(rfsts[7].UINT32,CAN_REG_BIT3,CAN_REG_LENGTH_1))
//     {
//         can_bus_receive_fifo_interrupt_flag.RxBuffer7 = 1U;
//         CAN_REG_CLR(rfsts[7].UINT32,CAN_REG_BIT3,CAN_REG_LENGTH_1);   //RFIF
//     }
// }
                                                ...
                                                unsigned char rule_count)
{
    ...
    */
    ...
    CAN_REG_SET(can->CFDGAFLECTR.UINT32,CAN_REG_BIT0,page_sel);//Sixteen receive rules can be set per page.     
    //can->GAFLECTR.BIT.AFLPN =(unsigned char)page_sel;

    // tiny_printf("RCFDCnCFDGAFLECTR:0x%08X\r\n", can->CFDGAFLECTR.UINT32);
...
void can_receive_rule_setting(CAN_REG_TYP * can, CAN_CHANNEL_SEL_e ch, unsigned short rule_count)
{
    ...
    */
    #if 1
    const unsigned char bit_shift_tbl[4] = 
    {
        CAN_REG_BIT24, CAN_REG_BIT16, CAN_REG_BIT8, CAN_REG_BIT0
    };
    unsigned char reg_sel  = ch >> 2; // 0 : ch 0 ~ 3 , 1 : ch 4 ~ 7
    unsigned char bit_shift = bit_shift_tbl[ch & 0x03];

    if (reg_sel)    // ch 4 ~ 7
    {
        CAN_REG_SET(can->CFDGAFLCFG1.UINT32,bit_shift,rule_count);    //page 0    for Channel 4~7   q =0~15
        tiny_printf("RCFDCnCFDGAFLCFG1:0x%02X-0x%04X-%d(0x%08X)\r\n",ch,bit_shift,rule_count,can->CFDGAFLCFG1.UINT32);
    }
    else    // ch 0 ~ 3
    {
        CAN_REG_SET(can->CFDGAFLCFG0.UINT32,bit_shift,rule_count);    //page 0    for Channel 0~3   q =0~15
        tiny_printf("RCFDCnCFDGAFLCFG0:0x%02X-0x%04X-%d(0x%08X)\r\n",ch,bit_shift,rule_count,can->CFDGAFLCFG0.UINT32);
    }
    #else
    ...
    {
        CAN_REG_SET(can->CFDGAFLCFG0.UINT32,ch_bit_shift,rule_count);    //page 0    for Channel 0~3   q =0~15
    }
    else
    {
        CAN_REG_SET(can->CFDGAFLCFG1.UINT32,ch_bit_shift,rule_count);    //page 0    for Channel 4~7   q =0~15
    }
    #endif
}

// static void can4_rrt_set(CAN_REG_TYP * can,
//                         CAN_BUS_HANDLE *p,
...
//         #else
//         p->rrt_handle[q].ptr0.bit.RMDP=can_bus_parameter_ch4.CAN_RX_FIFO_BUFFER_NUM;    //Set the receive buffer number to store received message.
//         #endif
//         // tiny_printf("can2_rrt_set-RMDP(%d):0x%08X\r\n", q , p->rrt_handle[q].ptr0.bit.RMDP);
...
//         //disable FIFO
//         #if 1
//         p->rrt_handle[q].ptr1.bit.FDPx=(rule + q)->GAFLFDP_x;   //Receive FIFO Buffer xx Select
//         #else
//         p->rrt_handle[q].ptr1.bit.FDPx=(0x1<<can_bus_parameter_ch4.CAN_RX_FIFO_BUFFER_NUM);        //Receive FIFO Buffer x Select
//         // p->rrt_handle[q].ptr1.bit.FDPx=0x1U;   //Receive FIFO Buffer 0 Select
//         #endif
//         // tiny_printf("can2_rrt_set-FDPx(%d):0x%08X\r\n", q , p->rrt_handle[q].ptr1.bit.FDPx);
...
//     {
//         //RCFDCnCFDGAFLIDj
//         p->rrt_handle[q].id.bit.ID = (rule + q)->GAFLID;  //rule[q].GAFLID;
//         p->rrt_handle[q].id.bit.LB = (rule + q)->GAFLLB;
//         p->rrt_handle[q].id.bit.IDE = (rule + q)->GAFLIDE;
//         p->rrt_handle[q].id.bit.RTR = (rule + q)->GAFLRTR;
        
//         //RCFDCnCFDGAFLMj
//         p->rrt_handle[q].mask.bit.MID = (rule + q)->GAFLIDM;
//         p->rrt_handle[q].mask.bit.MIDE = (rule + q)->GAFLIDEM;
//         p->rrt_handle[q].mask.bit.MRTR = (rule + q)->GAFLRTRM;

//         //RCFDCnCFDGAFLP0_j
//         p->rrt_handle[q].ptr0.bit.RMDP = (rule + q)->GAFLRMDP;        //Set the receive buffer number to store received message.
//         p->rrt_handle[q].ptr0.bit.RMV = (rule + q)->GAFLRMV;          //Receive Buffer disable
//         p->rrt_handle[q].ptr0.bit.PTR = (rule + q)->GAFLPTR;          //Receive Rule Label (additional infomation 12bit)
//         p->rrt_handle[q].ptr0.bit.DLC = (rule + q)->GAFLDLC;
        
//         //RCFDCnCFDGAFLP1_j
//         //enable RX FIFO
//         p->rrt_handle[q].ptr1.bit.FDPx = (rule + q)->GAFLFDP_x;     //Receive FIFO Buffer 0 Selected(select by bit filed)  / one FIFO buffer depth 128 message
//         p->rrt_handle[q].ptr1.bit.FDPk = (rule + q)->GAFLFDP_k;                                    //Transmit/Receive FIFO Buffer disable
//     }
//     #endif

//     can_receive_rule_setting(can,(CAN_CHANNEL_SEL_e)can_bus_parameter_ch4.CAN_CH,rule_count);
...
//     // CAN_REG_SET(can->CFDRMNB.UINT32,CAN_REG_BIT0,rule_count);     //NRXMB
// }
                                    ...
                                    unsigned char rule_count)
{
    ...
    for(q=0;q<rule_count;q++)
    {
        ...
        p->rrt_handle[q].ptr0.bit.RMDP=(rule + q)->GAFLRMDP;    //Set the receive buffer number to store received message.
        #else
        p->rrt_handle[q].ptr0.bit.RMDP=can_bus_parameter_ch0.CAN_RX_FIFO_BUFFER_NUM;    //Set the receive buffer number to store received message.
        #endif
        // tiny_printf("can_rrt_set-RMDP(%d):0x%08X\r\n", q , p->rrt_handle[q].ptr0.bit.RMDP);
        // p->rrt_handle[q].ptr0.bit.RMV=0;     //Receive Buffer disable
        p->rrt_handle[q].ptr0.bit.RMV=1;
        p->rrt_handle[q].ptr0.bit.PTR=0;     //Receive Rule Label (additional infomation 12bit)
        p->rrt_handle[q].ptr0.bit.DLC=(unsigned char)CAN_DLC_DISABLE_CHECK;
        ...
        p->rrt_handle[q].ptr1.bit.FDPx=(rule + q)->GAFLFDP_x;   //Receive FIFO Buffer xx Select
        #else
        p->rrt_handle[q].ptr1.bit.FDPx=(0x1<<can_bus_parameter_ch0.CAN_RX_FIFO_BUFFER_NUM);        //Receive FIFO Buffer x Select
        // p->rrt_handle[q].ptr1.bit.FDPx=0x1U;   //Receive FIFO Buffer 0 Select
        #endif
        // tiny_printf("can_rrt_set-FDPx(%d):0x%08X\r\n", q , p->rrt_handle[q].ptr1.bit.FDPx);
    ...
    //Setting for page 0(0~15) 
    {
        ...
        //RCFDCnCFDGAFLP1_j
        //enable RX FIFO
        p->rrt_handle[q].ptr1.bit.FDPx=(0x1<<can_bus_parameter_ch0.CAN_RX_FIFO_BUFFER_NUM);     //Receive FIFO Buffer 0 Selected(select by bit filed)  / one FIFO buffer depth 128 message
    ...
    can_receive_rule_setting(can,channel,rule_count);
...
//     can_receive_rule_setting(can,(CAN_CHANNEL_SEL_e)can_bus_parameter_ch1.CAN_CH,rule_count);
                         ...
                         
{
    ...
    #if defined (ENABLE_TDC)  // Transmitter Delay Compensation Enable
...
void can_rx_fifo_buf_int_check_all_channel(void)
{
    #if 1
    if (!s_can_cfg) 
    {
        s_can_cfg = CAN_GetConfig(&s_can_cnt);
    }

    // tiny_printf("s_can_cnt:%d\r\n", s_can_cnt);

    for (size_t i = 0; i < s_can_cnt; ++i) 
    {        
        const CAN_ChannelConfig *c = &s_can_cfg[i];
        // can_fd_receive_buffer_decode(&RCFDC0,c->parameter->CAN_RX_FIFO_BUFFER_NUM);
        can_rx_fifo_buf_int_check(&RCFDC0,c->p,c->parameter->CAN_RX_FIFO_BUFFER_NUM);
    }
    #else
    can_rx_fifo_buf_int_check(&RCFDC0,&can_bus_handle_ch0,can_bus_parameter_ch0.CAN_RX_FIFO_BUFFER_NUM);
    can_rx_fifo_buf_int_check(&RCFDC0,&can_bus_handle_ch2,can_bus_parameter_ch2.CAN_RX_FIFO_BUFFER_NUM);
    #endif
}

void can_rx_interrupt_cbk(void)
{    
    can_rx_fifo_buf_int_check_all_channel();

    // can_rx_fifo_interrupt_flag_check(&RCFDC0);    
    // can_rx_fifo_interrupt_flag_log(&RCFDC0);

}

// void can_run(void)
// {
// 	if(can_bus_variable_ch1.can_tx1_flag==1)
// 	{
// 		can_bus_variable_ch1.can_tx1_flag=0;
...
void can_rrt_set_all_channel(void)
{
    ...
    */
    ...
    #if defined (ENABLE_CAN1)
    // can_rrt_set(&RCFDC0,&can_bus_handle_ch1,can_bus_rx_rule_tbl_ch1,CAN_RX_RULE_CURRENT_AMOUNT);
    can_rrt_set_by_channel(&RCFDC0,
        &can_bus_handle_ch1,
        can_bus_parameter_ch1.CAN_CH,
        page_cnt,
        can_bus_rx_rule_tbl_ch1,
        CAN_RX_RULE_CURRENT_AMOUNT);
    page_cnt++;
    #endif
    ...
    can_rrt_set_by_channel(&RCFDC0,
        &can_bus_handle_ch3,
        can_bus_parameter_ch3.CAN_CH,
        page_cnt,
        can_bus_rx_rule_tbl_ch3,
        CAN_RX_RULE_CURRENT_AMOUNT);
    page_cnt++;
    #endif

    #if defined (ENABLE_CAN4)
    // can4_rrt_set(&RCFDC0,&can_bus_handle_ch4,can_bus_rx_rule_tbl_ch4,CAN_RX_RULE_CURRENT_AMOUNT);
    can_rrt_set_by_channel(&RCFDC0,
        &can_bus_handle_ch4,
        can_bus_parameter_ch4.CAN_CH,
        page_cnt,
        can_bus_rx_rule_tbl_ch4,
        CAN_RX_RULE_CURRENT_AMOUNT);
    page_cnt++;
    #endif
}
...
void can_init(void)
{
    ...
    const CAN_ChannelConfig *c = NULL;
    ...
    {        
        ...
        can_normal_mode_set(&RCFDC0,
                            c->parameter->CAN_MODE,
                            c->parameter->CAN_CH,
                            c->parameter->DSJW,                 //DSJW
                            c->parameter->DTSEG2,               //DTSEG2
                            c->parameter->DTSEG1,               //DTSEG1
                            c->parameter->DBRP,                 //DBRP
                            c->parameter->NSJW,                 //NSJW
                            c->parameter->NTSEG2,               //NTSEG2
                            c->parameter->NTSEG1,               //NTSEG1
                            c->parameter->NBRP                  //NBRP
                            );
        ...
        {
            init_once = 0;
            can_rrt_set_all_channel();
        }

        can_fifo_buffer_set(&RCFDC0,
                            c->parameter->CAN_RX_FIFO_BUFFER_NUM,
        ...
        // can_start(&RCFDC0,c->parameter->CAN_CH);

        // can_fifo_buffer_enable(&RCFDC0,c->parameter->CAN_RX_FIFO_BUFFER_NUM);
    }
    ...
    {        
        ...
        can_start(&RCFDC0,g_can_cfg[i].parameter->CAN_CH);

        can_fifo_buffer_enable(&RCFDC0,g_can_cfg[i].parameter->CAN_RX_FIFO_BUFFER_NUM);
    }
    ...
    can_handle_init(&can_bus_handle_ch0);

    can_normal_mode_set(&RCFDC0,
    					(CAN_FD_MODE_e)can_bus_parameter_ch0.CAN_MODE,
                        (CAN_CHANNEL_SEL_e)can_bus_parameter_ch0.CAN_CH,
                        (CAN_BIT_TIME_DSJW_SEL_e)can_bus_parameter_ch0.DSJW,              //DSJW
                        (CAN_BIT_TIME_DTSEG2_SEL_e)can_bus_parameter_ch0.DTSEG2,          //DTSEG2
                        (CAN_BIT_TIME_DTSEG1_SEL_e)can_bus_parameter_ch0.DTSEG1,          //DTSEG1
                        (CAN_BIT_TIME_DBRP_SEL_e)can_bus_parameter_ch0.DBRP,              //DBRP
                        (CAN_BIT_TIME_NSJW_SEL_e)can_bus_parameter_ch0.NSJW,              //NSJW
						(CAN_BIT_TIME_NTSEG2_SEL_e)can_bus_parameter_ch0.NTSEG2,          //NTSEG2
						(CAN_BIT_TIME_NTSEG1_SEL_e)can_bus_parameter_ch0.NTSEG1,          //NTSEG1
						(CAN_BIT_TIME_NBRP_SEL_e)can_bus_parameter_ch0.NBRP               //NBRP
                        );
    ...
    can_fifo_buffer_set(&RCFDC0,
                        (CAN_RX_FIFO_BUFER_NUMBER_e)can_bus_parameter_ch0.CAN_RX_FIFO_BUFFER_NUM,
                        #if defined (CAN_RX_POLLING)
                        CAN_RX_FIFO_BUFFER_INIERRUPT_DISABLE,   //CAN_RX_FIFO_BUFFER_INIERRUPT_ENABLE
                        #elif defined (CAN_RX_INTERRUPT)
                        CAN_RX_FIFO_BUFFER_INIERRUPT_ENABLE,
    ...
    can_start(&RCFDC0,can_bus_parameter_ch0.CAN_CH);

    //can_fifo_buffer_enable must execute after the can_start
    can_fifo_buffer_enable(&RCFDC0,can_bus_parameter_ch0.CAN_RX_FIFO_BUFFER_NUM);
...
{
    tiny_printf("CFDC0NCFG:0x%08X\r\n", RCFDC0.CFDC0NCFG.UINT32);
    tiny_printf("CFDC0CTR:0x%08X\r\n", RCFDC0.CFDC0CTR.UINT32);
    tiny_printf("CFDC0STS:0x%08X\r\n", RCFDC0.CFDC0STS.UINT32);
    tiny_printf("CFDC0ERFL:0x%08X\r\n", RCFDC0.CFDC0ERFL.UINT32);

    tiny_printf("CFDC1NCFG:0x%08X\r\n", RCFDC0.CFDC1NCFG.UINT32);
    tiny_printf("CFDC1CTR:0x%08X\r\n", RCFDC0.CFDC1CTR.UINT32);
    tiny_printf("CFDC1STS:0x%08X\r\n", RCFDC0.CFDC1STS.UINT32);
    tiny_printf("CFDC1ERFL:0x%08X\r\n", RCFDC0.CFDC1ERFL.UINT32);

    tiny_printf("CFDC2NCFG:0x%08X\r\n", RCFDC0.CFDC2NCFG.UINT32);
    tiny_printf("CFDC2CTR:0x%08X\r\n", RCFDC0.CFDC2CTR.UINT32);
    tiny_printf("CFDC2STS:0x%08X\r\n", RCFDC0.CFDC2STS.UINT32);
    tiny_printf("CFDC2ERFL:0x%08X\r\n", RCFDC0.CFDC2ERFL.UINT32);

    tiny_printf("CFDC3NCFG:0x%08X\r\n", RCFDC0.CFDC3NCFG.UINT32);
    tiny_printf("CFDC3CTR:0x%08X\r\n", RCFDC0.CFDC3CTR.UINT32);
    tiny_printf("CFDC3STS:0x%08X\r\n", RCFDC0.CFDC3STS.UINT32);
    tiny_printf("CFDC3ERFL:0x%08X\r\n", RCFDC0.CFDC3ERFL.UINT32);      
...
void can_rx_buffer_set(CAN_REG_TYP * can)
{
    ...
    CAN_REG_SET(can->CFDRMNB.UINT32,CAN_REG_BIT0,128);                      //NRXMB[7:0]  Receive Buffer Number Configuration 
    CAN_REG_SET(can->CFDRMNB.UINT32,CAN_REG_BIT8,CAN_REG_LENGTH_3);         //RMPLS[2:0]  Receive Buffer Payload Storage Size Select 

}

static void can_tx_no_normal_buffer_set(CAN_BUS_HANDLE *p,CAN_FD_MODE_e mode,unsigned int p_number,unsigned int transmit_buffer_id,unsigned char *txbuffer,unsigned char len )
{    
    unsigned int buf_cnt=0;
    unsigned short i=0;
    unsigned short dlc=0;
    ...
    {
        case 8:
            dlc = (unsigned short)CAN_DLC_8BYTE;
            break;
        case 16:
            dlc = (unsigned short)CAN_DLC_16BYTE;
            break;
        case 48:
            dlc = (unsigned short)CAN_DLC_48BYTE;
            break;
        case 64:
            dlc = (unsigned short)CAN_DLC_64BYTE;
            break;
...
signed char can_fd_receive_buffer_decode(CAN_REG_TYP * can, CAN_RX_FIFO_BUFER_NUMBER_e rfi_number)
{
    ...
    /*
        ...
        LQFP64 : CAN0 , CAN1 , CAN2
                ...
                r = 0 to 63
                y = 0, 1 
        LQFP100 : CAN0 , CAN1 , CAN2 , CAN3  , CAN4 , CAN5 
                m = 0 to 5 
                z = 0 to 5 
                j = 0 to 15 
                k = 0 to 17
    ...
    */
    ...
    if ( rmnd0[0].UINT32 != (0x1U << rfi_number)) // hard code
    {
        return -1;
    }
    ...
    */
    ...
    for(i = 0;i < 16 ; i++)
    {
        tiny_printf("[%2d:0x%08X]0x%08X\r\n",i,&rmdf0_0[i+q_number].UINT32,rmdf0_0[i+q_number].UINT32);
    }
...
void can_fd_receive_fifo_buffer_decode(CAN_REG_TYP * can, CAN_RX_FIFO_BUFER_NUMBER_e rfi_number)
{
    ...
    */
    ...
    for(i = 0;i < 16 ; i++)
    {
        tiny_printf("[%2d:0x%08X]0x%08X\r\n",i,&rfdf0_0[i+q_number].UINT32,rfdf0_0[i+q_number].UINT32);
    }
...
void can_fd_receive_fifo_buffer_status(CAN_REG_TYP * can, CAN_RX_FIFO_BUFER_NUMBER_e rfi_number)
{
    ...
    flag = (rmnd0[0].UINT32 | rmnd0[1].UINT32 | rmnd0[2].UINT32) ? 1 : 0;   
...
void can_fd_receive_buffer_decode_all_channel(void)
{
    #if 1
    if (!s_can_cfg) 
    {
    ...
    #else
    can_fd_receive_buffer_decode(&RCFDC0,can_bus_parameter_ch0.CAN_RX_FIFO_BUFFER_NUM);
    #endif
}
...
void can_tx_process(void)
{
	...
	if(can_bus_variable_ch0.can_tx4_flag==1)
	{
		can_bus_variable_ch0.can_tx4_flag=0;          
        
        // prepare data
        transmit_buffer_id = 0x008;
        p_number = 3;
        ...
        count += 0x10;
        can_tx_normal_buffer4_set(&can_bus_handle_ch0,can_bus_parameter_ch0.CAN_MODE,p_number,transmit_buffer_id,txbuffer);
		can_tx_buf_data_multi_send(&RCFDC0,&can_bus_handle_ch0.tx_handle[0],can_bus_parameter_ch0.CAN_CH,1,64);

        tiny_printf("CAN0 TX4 xfer finish\r\n");
	}

	if(can_bus_variable_ch0.can_tx3_flag==1)
	{
		can_bus_variable_ch0.can_tx3_flag=0;          
        
        // prepare data
        transmit_buffer_id = 0x007;
        p_number = 2;
        ...
        count += 0x10;
        can_tx_normal_buffer3_set(&can_bus_handle_ch0,can_bus_parameter_ch0.CAN_MODE,p_number,transmit_buffer_id,txbuffer);
		can_tx_buf_data_multi_send(&RCFDC0,&can_bus_handle_ch0.tx_handle[0],can_bus_parameter_ch0.CAN_CH,1,16);

        tiny_printf("CAN0 TX3 xfer finish\r\n");
	}

	if(can_bus_variable_ch0.can_tx2_flag==1)
	{
		can_bus_variable_ch0.can_tx2_flag=0;          
        
        // prepare data
        transmit_buffer_id = 0x006;
        p_number = 1;

        can_tx_normal_buffer2_set(&can_bus_handle_ch0,can_bus_parameter_ch0.CAN_MODE,p_number,transmit_buffer_id);
		can_tx_buf_data_multi_send(&RCFDC0,&can_bus_handle_ch0.tx_handle[0],can_bus_parameter_ch0.CAN_CH,1,32);

        tiny_printf("CAN0 TX2 xfer finish\r\n");
	}

	if(can_bus_variable_ch0.can_tx1_flag==1)
	{
		can_bus_variable_ch0.can_tx1_flag=0;        
        
        // prepare data
        transmit_buffer_id = 0x005;
        p_number = 0;

        can_tx_normal_buffer1_set(&can_bus_handle_ch0,can_bus_parameter_ch0.CAN_MODE,p_number,transmit_buffer_id);
		can_tx_buf_data_multi_send(&RCFDC0,&can_bus_handle_ch0.tx_handle[0],can_bus_parameter_ch0.CAN_CH,1,64);

        tiny_printf("CAN0 TX1 xfer finish\r\n");
	}
    #endif
	...
	if(can_bus_variable_ch1.can_tx4_flag==1)
	{
		can_bus_variable_ch1.can_tx4_flag=0;          
        
        // prepare data
        transmit_buffer_id = 0x108;
        p_number = 3;
        ...
        tiny_printf("CAN1 TX4 xfer finish\r\n");
	}

	if(can_bus_variable_ch1.can_tx3_flag==1)
	{
		can_bus_variable_ch1.can_tx3_flag=0;          
        
        // prepare data
        transmit_buffer_id = 0x107;
        p_number = 2;
        ...
        tiny_printf("CAN1 TX3 xfer finish\r\n");
	}

	if(can_bus_variable_ch1.can_tx2_flag==1)
	{
		can_bus_variable_ch1.can_tx2_flag=0;          
        
        // prepare data
        transmit_buffer_id = 0x106;
        p_number = 1;
        ...
        tiny_printf("CAN1 TX2 xfer finish\r\n");
	}
	...
	if(can_bus_variable_ch2.can_tx4_flag==1)
	{
		can_bus_variable_ch2.can_tx4_flag=0;          
        ...
        tiny_printf("CAN2 TX4 xfer finish\r\n");
	}
    
	if(can_bus_variable_ch2.can_tx3_flag==1)
	{
		can_bus_variable_ch2.can_tx3_flag=0;          
        ...
        tiny_printf("CAN2 TX3 xfer finish\r\n");
	}
    
	if(can_bus_variable_ch2.can_tx2_flag==1)
	{
		can_bus_variable_ch2.can_tx2_flag=0;          
        ...
        for(i = 0; i < len ;i++)
        {
            txbuffer[i] = 0x20+i+count;
        }
        count += 0x10;
        can_tx_no_normal_buffer_set(&can_bus_handle_ch2,can_bus_parameter_ch2.CAN_MODE,p_number,transmit_buffer_id,txbuffer,len);
		can_tx_buf_data_multi_send(&RCFDC0,&can_bus_handle_ch2.tx_handle[0],can_bus_parameter_ch2.CAN_CH,1,len);

        tiny_printf("CAN2 TX2 xfer finish\r\n");
	}

	if(can_bus_variable_ch2.can_tx1_flag==1)
	{
		can_bus_variable_ch2.can_tx1_flag=0;          
        ...
        tiny_printf("CAN2 TX1 xfer finish\r\n");
	}
	...
	if(can_bus_variable_ch3.can_tx4_flag==1)
	{
		can_bus_variable_ch3.can_tx4_flag=0;          
        
        // prepare data
        transmit_buffer_id = 0x308;
        p_number = 7;
        len = 64;
        ...
        count += 0x10;
        can_tx_no_normal_buffer_set(&can_bus_handle_ch3,can_bus_parameter_ch3.CAN_MODE,p_number,transmit_buffer_id,txbuffer,len);
		can_tx_buf_data_multi_send(&RCFDC0,&can_bus_handle_ch3.tx_handle[0],can_bus_parameter_ch3.CAN_CH,1,len);

        tiny_printf("CAN3 TX4 xfer finish\r\n");
	}
    
	if(can_bus_variable_ch3.can_tx3_flag==1)
	{
		can_bus_variable_ch3.can_tx3_flag=0;          
        
        // prepare data
        transmit_buffer_id = 0x307;
        p_number = 6;
        len = 48;
        ...
        tiny_printf("CAN3 TX3 xfer finish\r\n");
	}
    
	if(can_bus_variable_ch3.can_tx2_flag==1)
	{
		can_bus_variable_ch3.can_tx2_flag=0;          
        
        // prepare data
        transmit_buffer_id = 0x306;
        p_number = 5;
        len = 16;
        ...
        tiny_printf("CAN3 TX2 xfer finish\r\n");
	}

	if(can_bus_variable_ch3.can_tx1_flag==1)
	{
		can_bus_variable_ch3.can_tx1_flag=0;          
        
        // prepare data
        transmit_buffer_id = 0x305;
        p_number = 4;
        len = 8;
        ...
        tiny_printf("CAN3 TX1 xfer finish\r\n");
	}
	...
	if(can_bus_variable_ch4.can_tx4_flag==1)
	{
		can_bus_variable_ch4.can_tx4_flag=0;          
        
        // prepare data
        transmit_buffer_id = 0x408;
        p_number = 7;
        len = 64;
        ...
        count += 0x10;
        can_tx_no_normal_buffer_set(&can_bus_handle_ch4,can_bus_parameter_ch4.CAN_MODE,p_number,transmit_buffer_id,txbuffer,len);
		can_tx_buf_data_multi_send(&RCFDC0,&can_bus_handle_ch4.tx_handle[0],can_bus_parameter_ch4.CAN_CH,1,len);

        tiny_printf("CAN4 TX4 xfer finish\r\n");
	}
    
	if(can_bus_variable_ch4.can_tx3_flag==1)
	{
		can_bus_variable_ch4.can_tx3_flag=0;          
        
        // prepare data
        transmit_buffer_id = 0x407;
        p_number = 6;
        len = 48;
        ...
        tiny_printf("CAN4 TX3 xfer finish\r\n");
	}
    
	if(can_bus_variable_ch4.can_tx2_flag==1)
	{
		can_bus_variable_ch4.can_tx2_flag=0;          
        
        // prepare data
        transmit_buffer_id = 0x406;
        p_number = 5;
        len = 16;
        ...
        tiny_printf("CAN4 TX2 xfer finish\r\n");
	}

	if(can_bus_variable_ch4.can_tx1_flag==1)
	{
		can_bus_variable_ch4.can_tx1_flag=0;          
        
        // prepare data
        transmit_buffer_id = 0x405;
        p_number = 4;
        len = 8;
        ...
        tiny_printf("CAN4 TX1 xfer finish\r\n");
	}
