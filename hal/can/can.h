...
#define RX0_RRT0_ID		0x100
#define RX0_RRT1_ID		0x101
#define RX0_RRT2_ID		0x102
#define RX0_RRT3_ID		0x103
#define RX0_RRT4_ID		0x104
#define RX0_RRT5_ID		0x105
#define RX0_RRT6_ID		0x106
#define RX0_RRT7_ID		0x107
#define RX0_RRT8_ID		0x108
#define RX0_RRT9_ID		0x109

#define RX1_RRT0_ID		0x200
#define RX1_RRT1_ID		0x201
#define RX1_RRT2_ID		0x202
#define RX1_RRT3_ID		0x203
#define RX1_RRT4_ID		0x204
#define RX1_RRT5_ID		0x205
#define RX1_RRT6_ID		0x206
#define RX1_RRT7_ID		0x207
#define RX1_RRT8_ID		0x208
#define RX1_RRT9_ID		0x209

#define RX2_RRT0_ID		0x300
#define RX2_RRT1_ID		0x301
#define RX2_RRT2_ID		0x302
#define RX2_RRT3_ID		0x303
#define RX2_RRT4_ID		0x304
#define RX2_RRT5_ID		0x305
#define RX2_RRT6_ID		0x306
#define RX2_RRT7_ID		0x307
#define RX2_RRT8_ID		0x308
#define RX2_RRT9_ID		0x309

#define RX3_RRT0_ID		0x400
#define RX3_RRT1_ID		0x401
#define RX3_RRT2_ID		0x402
#define RX3_RRT3_ID		0x403
#define RX3_RRT4_ID		0x404
#define RX3_RRT5_ID		0x405
#define RX3_RRT6_ID		0x406
#define RX3_RRT7_ID		0x407
#define RX3_RRT8_ID		0x408
#define RX3_RRT9_ID		0x409

#define RX4_RRT0_ID		0x500
#define RX4_RRT1_ID		0x501
#define RX4_RRT2_ID		0x502
#define RX4_RRT3_ID		0x503
...
typedef struct _can_bus_global_variable_t
{
...
typedef struct _can_bus_rx_fifo_flag_t
{
    ...
    unsigned char RxBuffer3;
    unsigned char RxBuffer4;
    unsigned char RxBuffer5;
    unsigned char RxBuffer6;
    unsigned char RxBuffer7;
}CAN_BUS_RX_FIFO_FLAG_T;
...
{
    CAN_BUS_HANDLE                      *p;
    const CAN_BUS_PARAMETER_T           *parameter;
    const CAN_RX_RULE_TABLE_T           *rx_rule_tbl;

    unsigned short                      rx_rule_count;
...
extern CAN_BUS_HANDLE can_bus_handle_ch0;
extern volatile CAN_BUS_GLOBAL_VARIABLE_T can_bus_variable_ch0;
extern const CAN_BUS_PARAMETER_T can_bus_parameter_ch0;
extern const CAN_RX_RULE_TABLE_T can_bus_rx_rule_tbl_ch0[CAN_RX_RULE_CURRENT_AMOUNT];
#endif

#if defined (ENABLE_CAN1)
extern CAN_BUS_HANDLE can_bus_handle_ch1;
extern volatile CAN_BUS_GLOBAL_VARIABLE_T can_bus_variable_ch1;
extern const CAN_BUS_PARAMETER_T can_bus_parameter_ch1;
extern const CAN_RX_RULE_TABLE_T can_bus_rx_rule_tbl_ch1[CAN_RX_RULE_CURRENT_AMOUNT];
#endif

#if defined (ENABLE_CAN2)
extern CAN_BUS_HANDLE can_bus_handle_ch2;
extern volatile CAN_BUS_GLOBAL_VARIABLE_T can_bus_variable_ch2;
extern const CAN_BUS_PARAMETER_T can_bus_parameter_ch2;
extern const CAN_RX_RULE_TABLE_T can_bus_rx_rule_tbl_ch2[CAN_RX_RULE_CURRENT_AMOUNT];
#endif

#if defined (ENABLE_CAN3)
extern CAN_BUS_HANDLE can_bus_handle_ch3;
extern volatile CAN_BUS_GLOBAL_VARIABLE_T can_bus_variable_ch3;
extern const CAN_BUS_PARAMETER_T can_bus_parameter_ch3;
extern const CAN_RX_RULE_TABLE_T can_bus_rx_rule_tbl_ch3[CAN_RX_RULE_CURRENT_AMOUNT];
#endif

#if defined (ENABLE_CAN4)
extern CAN_BUS_HANDLE can_bus_handle_ch4;
extern volatile CAN_BUS_GLOBAL_VARIABLE_T can_bus_variable_ch4;
extern const CAN_BUS_PARAMETER_T can_bus_parameter_ch4;
extern const CAN_RX_RULE_TABLE_T can_bus_rx_rule_tbl_ch4[CAN_RX_RULE_CURRENT_AMOUNT];
#endif
